...
export type GovernmentCommunicationFacts={custodians:string[];dates:string[];subjects:string[];keywords:string[];outsideParties:string[];systems:string[];threadIds:string[];referencedAttachments:string[]}
...
export type GovernmentCommunicationStrategy={action:'request-follow-up'|'seek-search-details'|'seek-withholding-basis'|'narrow-scope'|'no-action';rationale:string}
