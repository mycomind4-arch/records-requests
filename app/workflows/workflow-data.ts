...
export const workflows: Workflow[] = [
  ...
  },
  {
    ...
    seo: seo('Background Check Records Request', 'Build a background check records request for screening reports and related records from the agency that conducted or maintains the check.', ['background check records request','request background check','background screening records','background check report request','criminal background check records','employment background check request','background check file request','how to request background check records','background investigation records request'], [faq('How do I request background check records?','Identify the agency and the person who was screened.'), faq('Can I request my own background check?','Yes, you can generally request your own records.'), faq('What information is in a background check?','May include criminal history, employment verification, and education verification.'), faq('How long does it take?','Processing times vary by agency.')]),
  },
  {
    ...
    description: 'Request military service records, personnel files, discharge papers, and related military records from the appropriate branch or archives.',
    bestFor: ['Service records', 'DD-214', 'Personnel files', 'Military awards'],
    cta: 'Request military records',
    seo: seo('Military Records Request — Service Records & DD-214', 'Build a military records request for service records, personnel files, discharge papers, and related records from the appropriate branch or archives.', ['military records request','military service records','request DD-214','military personnel file','service records request'], [faq('How do I request military records?','Identify the agency (NPRC, VA, branch), the veteran, and service period.'), faq('What is a DD-214?','A DD Form 214 is the certificate of release or discharge from active duty.'), faq('Who can request military records?','The veteran or next of kin generally can. Some records are available under FOIA.'), faq('Where are military records held?','Most at the National Personnel Records Center (NPRC) in St. Louis.')]),
  },
  {
    ...
    seo: seo('Medical Records Request — Health Records & Test Results', 'Build a medical records request for treatment histories, test results, and related health records from the appropriate provider or facility.', ['medical records request','request medical records','health records request','patient records request','HIPAA records request'], [faq('How do I request medical records?','Identify the provider, patient name, and treatment period. HIPAA gives patients the right to access their records.'), faq('How long does a provider have to respond?','Under HIPAA, generally 30 days, with one 30-day extension allowed.'), faq('Can I be charged for copies?','Providers may charge reasonable, cost-based fees for copying.'), faq('What if the provider refuses?','You can file a complaint with HHS Office for Civil Rights.')]),
  },
  {
    ...
    description: 'Request employment records, personnel files, payroll records, and related employment records from an employer or former employer.',
    bestFor: ['Personnel files', 'Payroll records', 'Performance evaluations'],
    cta: 'Request employment records',
    seo: seo('Employment Records Request — Personnel Files & Payroll', 'Build an employment records request for personnel files, payroll records, and related employment records from an employer or former employer.', ['employment records request','personnel file request','request employment records','payroll records request'], [faq('How do I request employment records?','Identify the employer, employee name, and employment period.'), faq('Can I request my own personnel file?','Many states give employees the right to inspect their personnel file.'), faq('What records can I request?','Personnel files, payroll, time and attendance, evaluations, and related records.'), faq('What if the employer refuses?','State labor laws vary on access rights and enforcement.')]),
  },
  {
  ...
  },
  {
    ...
    description: 'Request a specific police or incident report by report number, date, location, and involved parties with enough detail for the agency to search.',
  ...
  },
  {
    ...
    description: 'Request a certified or duplicate copy of a police report, including fees, format, and delivery preferences for official or legal use.',
  ...
  },
  {
    ...
    description: 'Request open records and government documents under state and local open records laws with the specificity agencies require to search.',
    bestFor: ['Open records', 'State records', 'Local government records'],
    cta: 'Build an open records request',
    seo: seo('Open Records Request — State & Local Government Records', 'Build an open records request for state and local government records under applicable open records laws with the specificity agencies need to search.', ['open records request','open records law','request open records','state open records','open records act request','how to request open records','open government records request','local open records request','open records request template','open records request form'], [faq('What is an open records request?','A request for government records under state or local open records laws.'), faq('How is this different from FOIA?','FOIA applies to federal agencies; open records laws apply to state and local government.'), faq('How long does the agency have to respond?','Response times vary by state law, typically 3-10 business days.'), faq('Can the agency deny my request?','Yes, but they must cite the specific exemption. You can appeal.')]),
  },
  {
  ...
  },
  {
    ...
    description: 'Request government documents, reports, publications, and official records from a government agency with enough specificity for a proper search.',
