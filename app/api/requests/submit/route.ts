...
import type { RequestStateRepository } from '../../../../src/request-repository'
...
async function reconcileFailure(repository: RequestStateRepository, id: string, actor: string, error: unknown) {
